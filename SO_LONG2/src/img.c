...
/*   Updated: 2022/05/04 22:22:28 by pcatapan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_img(t_map *map)
{
	...
	map->img->player = mlx_xpm_file_to_image(map->mlx_ptr, PLAYERS, \
							&map->img->w, &map->img->h);
